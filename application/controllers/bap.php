	...
	*/
	...
	public function index()
	{
		if($this->session->userdata('logged_in')!="")
		{
			...
			$d['tot'] = $offset;
			$tot_hal = $this->app_model->getAllData("t_kecelakaan");
			$config['base_url'] = site_url() . '/bap/index/';
			...
			$d['data'] = $this->app_model->getAllDataLimited("t_kecelakaan",$limit,$offset);
			
			$d['content']= $this->load->view('bap/daftar',$d,true);
