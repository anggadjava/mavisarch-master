...
class Tagihan_model extends CI_Model {
	...
	public function getListTunggakan($nis)
	{
		$this->db->select('tagihan.*, SUM(kwitansi_item.jumlah_bayar) as totbay,besar_tagihan - potongan - SUM( kwitansi_item.jumlah_bayar ) AS kurang_bayar');
		$this->db->where('nis =',$nis);
		$this->db->join('kwitansi_item', 'tagihan.id = kwitansi_item.id_tagihan', 'left');
		$this->db->group_by("tagihan.id"); 
		return $this->db->get('tagihan');
	}
