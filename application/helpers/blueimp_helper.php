...
class Blueimp
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/guru/uploadFoto',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/asset/uploads/',
            'upload_url' => $this->get_full_url().'/asset/uploads/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
